...
# 🌳 Graph Visualization
st.subheader("Information Gain Graph")

gains = [information_gain(data, attr, 'PlayTennis') for attr in attributes]

plt.figure()
plt.bar(attributes, gains)
plt.xlabel("Attributes")
plt.ylabel("Information Gain")
plt.title("Information Gain of Attributes")
